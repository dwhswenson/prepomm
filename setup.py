...
REQUIREMENTS=['future', 'numpy', 'mdtraj', 'scipy', 'openmm', 'pdbfixer',
              'parmed']
...
PACKAGES=['prepomm', 'prepomm.tests']

# This DESCRIPTION is only used if a README.rst hasn't been made from the
# markdown version
DESCRIPTION="""
"""
SHORT_DESCRIPTION="Tools to prepare an OpenMM simulation"
...
if __name__ == "__main__":
    write_version_py(os.path.join('prepomm', 'version.py'))
    setup(
        name="prepomm",
        ...
        version=PACKAGE_VERSION,
        license="MIT",
        url="http://github.com/dwhswenson/prepomm",
        packages=PACKAGES,
        package_dir={p: '/'.join(p.split('.')) for p in PACKAGES},
        package_data={'prepomm': ['tests/*pdb']},
        ext_modules=[],
        scripts=[],
